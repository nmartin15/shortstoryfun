...
- [ ] Add support for experimental forms (novella scaffolding, serialized short stories)
- [ ] Build language "pop" database: Curated examples of memorable phrases, unique word choices
- [ ] Develop character archetype breaker: Tools to subvert and complicate stock characters
- [ ] Create voice pattern library: Templates for distinctive narrative and character voices
